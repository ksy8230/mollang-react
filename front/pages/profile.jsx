        ...
        <div className='contents-wrap'>
            <div className='profile'>
                ...
                <div className='box'>
                    ...
                    <div className={openPastBox ? 'feature active' : 'feature'}>
                        ...
                        <div className='detail'>
                            <p>
                                ...
                                유효기간이 있는 홍보성 페이지인 <a className='link' href='/html/campaign.html'>캠페인</a> 단위로 단타성 작업을 많이 하였고, 회원가입 / 로그인 / 마이페이지 등과 같은 <a href=''>시스템 코딩</a> 업무도 겸하였습니다.<br/>
                                ...
                                업무가 주어지는 방식은 캠페인 하나당 디자이너 1명 퍼블리셔 1명으로 배정되어 진행되었고, 모든 업무는 협업관리툴인 <span>트렐로</span>에 공유가 되었습니다.
                            </p>
                        </div>
                    </div>
                    <div className={openFutureBox ? 'feature active' : 'feature'}>
                        ...
                        <div className='detail'>
                            ...
                            <h4>흐름 파악이 중요한 사람</h4>
                            <p>
                                프론트엔드단과 백엔드단 그리고 배포까지 전반적인 흐름을 알고 싶어 수강한 강좌를 통해 <span>vanilaJS</span> <span>nodeJS</span> <span>express</span> 를 기반으로 한 <a href=''>냉장고프로젝트</a> 사이트를 만들어보았습니다. (참고 강의 : 노마드님의 [풀스택] 유튜브 만들기)
                            </p><br/>
                            <h4>트렌드 기술에 관심이 많아요</h4>
                            <p>
                                냉장고프로젝트 작업 이후 메뉴 화면 이동시 새로고침이 되는 화면이 아닌 상태값을 유지하며 라우터가 이동되는 SPA(Single Page Application)을 만들어 보고 싶어 <span>REACT</span> 관련 강좌를 토대로 <a href=''>이박사물회</a> 사이트를 만들게 됐습니다. (참고 강의 : 제로초님의 리액트로 웹게임 만들기)
                            </p><br/>
                            <h4>더 나은 구현물에 욕심이 나요</h4>
                            <p>
                                단순히 보여지는 소개용 페이지들에서 더 나아가 컨텐츠를 추가하고 조회하고 수정하고 삭제하는 기능이 있는 사이트를 만들어 보고 싶어 리액트 관련 강좌를 토대로 이전에 만들었던 냉장고프로젝트의 리액트 버전인 <a href=''>냉장고 프로젝트 리액트</a> 사이트를 만들었습니다. (참고 강의 : 제로초님의 리액트로 노드버드 만들기)<br/>
                            ...
                            <p>
                                ...
                                기본이 튼튼한 개발자가 되기 위해 <a href=''>몰로그</a>를 만들게 되었고 <br />
                ...
                <div className='box skill'>
                    ...
                    <div className='feature'>
                        <p className='title'><span>{`<id="백엔드"> `}</span>퍼블리싱과 SPA 프레임워크</p>
                        <div className='detail'>
                            <ul>
                                <li>

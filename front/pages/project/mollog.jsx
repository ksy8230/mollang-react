            ...
            <div className='project_detail'>
                ...
                <section className='outline'>
                    ...
                    <p>
                        ...
                        강의를 보며 만든 냉장고 프로젝트 이후 복습을 위한 작업물이자 조금 더 업그레이를 시킨 작업물로, 편집기가 추가되었으며 관리자단이 생성되었습니다.
                    </p>
                </section>
                <section className=''>
                    <h3>해당 작업물 구성 요소</h3>
                    <p>
                        ...
                        - 해시태그 클릭시 해당하는 포스트들만 보이는 화면으로 넘어갑니다.<br />
                        - 각 포스트들 클릭시 포스트 상세 페이지로 넘어갑니다.<br /><br />
                        포스트 상세 화면<br />
                        - h태그를 기준으로 우측에 해당 포스트의 제목별 링커가 생성되어 해당하는 위치로 스크롤이 가능합니다.<br /><br />
                        프로젝트 화면<br />
                        - 근무시 진행했던 작업사항들과 개인적으로 만든 프로젝트들에 대한 정보를 전달합니다.<br /><br />
                        관리자 화면<br />
                        - admin ID로만 접근 가능한 페이지로 편집기를 이용해 포스팅 작성이 가능합니다.<br />
                ...
                <section className='skills'>
                    ...
                    <p>
                        ...
                        - AWS S2 이용해 우분투 예정<br />
                        - AWS Route53 이용해 도메인 연결 예정<br />
                        - AWS S3 이용해 이미지 업로드 예정<br />
                    </p>
                    <span className='issue'><Link href='/tag/몰로그' ><a><FontAwesomeIcon icon={faWrench} />개발 이슈</a></Link></span>
                </section>
